...
export function PasswordInput({ 
  ...
  return (
    <div {...rest}>
      ...
      <input disabled={isDisabled} required onChange={e => setPassword(e.currentTarget.value)} className="w-full disabled:opacity-30 bg-super-dark text-[1.35rem] focus-within:outline-0 pl-11 pr-3 py-2.5 rounded-lg" type={isHide ? "password" : "text"} name="email" id="email" autoComplete="on" placeholder={placeholder} />
      {
        isHide
